...
let card2a = new MemoryButton(canvas, pencil, 50, 200, color2);
let card2b = new MemoryButton(canvas, pencil, 200, 200, color2);

let color3 = toolbox.getRandomColor();
let card3a = new MemoryButton(canvas, pencil, 50, 350, color3);
let card3b = new MemoryButton(canvas, pencil, 200, 350, color3);
